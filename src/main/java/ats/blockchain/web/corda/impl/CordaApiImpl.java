...
public class CordaApiImpl implements CordaApi {
	...
	public void init() throws DiamondWebException {
		...
		if ((permconfighelperinf.getRpcsettingstruct() != null)
				&& !StringUtil.isNull(permconfighelperinf.getRpcsettingstruct().getAddress())) {
	...
	private void initCache() {
		...
		logger.info("init basketno and giano cache end, basketno number: {},giano number: {}", pkgSet.size(),
				gianoSet.size());
